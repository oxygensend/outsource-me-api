 ...
 */
final class Version20221020192759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE technology ADD CONSTRAINT FK_F463524D8F8A14FA FOREIGN KEY (technologies_id) REFERENCES job_offer (id)');
